...
########################################################
def visualize(state, data, inliers, num_dist, pg_bound, mm_bound,state_name,election_name, v_bar):
    ...
    for i in seats_figs:
        ...
        i.set_xticks([x + 0.0 for x in range(num_dist + 2)]) # think about how to center the ticks...
        i.set_xticklabels(range(num_dist + 1))
        i.axvline(x=v_bar*(num_dist+1), color="black", linestyle="dashed", linewidth=2, label="proportionality (" + str(round(v_bar * 100, 1)) + "% Rep. seats)")
    ...
    for i in range(3):
        ...
        leg2 = seats_figs[i].legend(loc="center left")
...
# ax.add_artist(leg1)
    ...
    fig1.savefig(newdir+state_name+election_name+"_"+"_seats.png")
    fig2.savefig(newdir+state_name+election_name+"_"+"_pgseats.png")
    fig3.savefig(newdir+state_name+election_name+"_"+"_mmseats.png")
    fig4.savefig(newdir+state_name+election_name+"_"+"_all.png")
...
############################################################
visualize(state_abbr+"-"+election_name, df, [9,11], 13, 0.01, 0.001,state_name,election_name, v_bar)
#"""
